...
class TrainingArguments(transformers.TrainingArguments):
    cache_dir: Optional[str] = field(default='/DATA/DATA2/jzh/video_benchmark/cache')
...
class LazySupervisedDataset(Dataset):
    ...
    def _get_item(self, i) -> Dict[str, torch.Tensor]:
        ...
        if "image" in sources[0] and  "frames per sec" not in sources[0]:
            ...
            if type(image_file) is list:
                ...
                image = [([[self.process_image(image_file)],[self.process_image(image_file)]])]
    ...
    #        try:
            if "shareVideoGPTV" in video_file:
                    ...
                    image = [([[image[:image.shape[0]//8*8]], [image[frame_idx]]], video[0].size, "video")]
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        if "image" in instances[0]:
            ...
            images = [im[0] for im_list in images for im in im_list][0]
