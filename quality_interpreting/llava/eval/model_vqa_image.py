...
def eval_model(args):
    ...
    for file in ['/tos-bjml-researcheval/jiaziheng/qbench/llvisionqa_test.json']:
        ...
        for i, llddata in enumerate((tqdm(llvqa_data))):
            ...
            prefix_text = "You will receive one image. Please analyze these images and answer the questions based on your observations."
            ...
            check_questions += 1
            if ["A", "B", "C", "D"][llddata["candidates"].index(llddata["correct_ans"])] ==outputs[0]:
                    correct += 1
            ...
            with open(f"/tos-bjml-researcheval/jiaziheng/VQA++/Visual-Question-Answering-for-Video-Quality-Assessment/VQA_benchmark_test/{args.model_path.split('/')[-1]}_" + f"{file.split('/')[-1].split('_')[-1][:-5]}_answer_image.json", "w") as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", type=str, default="/tos-bjml-researcheval/jiaziheng/VQA++/project_model_for_supervision/llava-ov-chat-qwen2-chatter")
